...
* **Engineer-programmer - VitebskEnergo**  
    ...
    * Participating in the implementation of new software and enhancement of existing software.
    * Creating tables and charts using SQL queries (PostgreSQL) in Apache Superset.
    * Providing technical support to users for the implemented software.

* **Engineer-programmer - VitebskEnergo**  
    *Polotsk, Belarus | November 2022 - November 2024*   
...
* **English:** A2 (Elementary)
    * **Language Practice:** I regularly read technical documentation and watch programming tutorials in English to improve my skills. I am actively working on improving my speaking and writing skills. I use the Duolingo mobile app for daily practice.
